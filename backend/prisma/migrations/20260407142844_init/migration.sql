...
-- CreateEnum
CREATE TYPE "Category" AS ENUM ('RESTAURANT', 'TOURISM', 'HOTEL', 'PRODUCT', 'OTHER');
...
-- AddForeignKey
ALTER TABLE "Favorite" ADD CONSTRAINT "Favorite_spotId_fkey" FOREIGN KEY ("spotId") REFERENCES "Spot"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
